export const compendiumStyles = {
  ...
  searchInput: "w-full pl-10 pr-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:border-cyan-500",
  filterToggle: "flex items-center gap-2 text-slate-300 hover:text-white transition-colors",
  filterContainer: "mt-3 space-y-3",
  filterLabel: "block text-xs font-medium text-slate-400 mb-1",
  filterSelect: "w-full px-3 py-1 bg-slate-700 border border-slate-600 rounded text-white text-sm focus:outline-none focus:border-cyan-500",
  ...
  entryItem: "p-4 border-b border-slate-700 cursor-pointer hover:bg-slate-700 transition-colors",
  entryItemSelected: "p-4 border-b border-slate-700 cursor-pointer hover:bg-slate-700 transition-colors bg-slate-700 border-l-4 border-l-cyan-500",
  ...
  primaryBadge: "px-3 py-1 bg-cyan-600 text-cyan-100 rounded-full text-sm font-medium",
...
export const compendiumButtonStyles = {
  container: "absolute top-4 right-80 z-50 compendium-button",
  button: "group relative bg-slate-800 hover:bg-slate-700 border-2 border-cyan-500 hover:border-cyan-400 rounded-full w-12 h-12 flex items-center justify-center transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-cyan-500/25",
  ...
  tooltip: "absolute right-full mr-3 px-3 py-2 bg-slate-800 border border-slate-600 rounded-lg text-white text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap",
  tooltipArrow: "absolute right-0 top-1/2 transform translate-x-1 -translate-y-1/2 w-2 h-2 bg-slate-800 border-r border-t border-slate-600 rotate-45"
};
